...
inline lld f(lli n)
{
    vector<lli> p = {0, 0, 0, 0, 0, 0, 0, 0, 200, 225, 250, 275, 300, 325, 350, 375, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400};
    return p[(lli)n / 5] / 100.00;
}
int main()
{
    ...
    tc
    {
        ...
        if(flag==1)cout<<"Sorry, you have failed in 1 course!"<<endl;
        else if(flag)cout<<"Sorry, you have failed in "<<(lli)flag<<" courses!"<<endl;
        else cout<<setpre(2)<<1.0*ans/(1.0*cnt)<<endl;
    }
}