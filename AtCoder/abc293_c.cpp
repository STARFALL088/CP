...
// *****************************************************
int n, m;
vector<vector<lli>> arr(1006, vector<lli>(1006));
vector<vector<lli>> vis(1006, vector<lli>(1006));
unordered_map<lli,lli>mp;
bool isValid(int x, int y)
{
    return (x >= 0 && x < n && y >= 0 && y < m && mp[arr[x][y]]==0);
}
lli ans=0;
...
int main() {
    ...
    tc0 {
        ...
        dfs(0,0);
        //loop(i,n)loop(j,m)cout<<vis[i][j]<<(j==m-1?"\n":"");
