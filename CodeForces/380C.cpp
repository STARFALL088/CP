...
node query(lli idx, lli low, lli high, lli l, lli r)
{
    // no overlap
    if (l > high || r < low)
    {
        ...
        while (q--)
            {
                ...
                cin >> l >> r;
                //cerr << "ans------------->";
                cout << query(0, 0, n - 1, --l, --r).full << endl;
            }
    }
}