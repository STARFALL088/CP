...
int main()
{
    ...
    tc0
    {
        ...
        lli x = 0, o = 0;
        loop(i, 3) loop(j, 3) x += s[i][j] == 'X', o += s[i][j] == '0';
        ...
        if (x + o < 9)
        {
            if (x > o)
            {
                for (int i = 0; i < n; i++)
                {
                    if (s[i % 3] == "XXX" and s[(i + 1) % 3] != "000" and s[(i + 2) % 3] != "000")
                    {
                        cout << "the first player won";
                        return 0;
                    }
                    else if (s[i % 3] == "XXX" and (s[(i + 1) % 3] == "000" or s[(i + 2) % 3] == "000"))
                    {
                        cout << "illegal" << endl;
                        return 0;
                    }
                ...
                for (int i = 0; i < n; i++)
                {
                    if (z[i % 3] == "XXX" and z[(i + 1) % 3] != "000" and z[(i + 2) % 3] != "000")
                    {
                        cout << "the first player won";
                        return 0;
                    }
                    else if (z[i % 3] == "XXX" and (z[(i + 1) % 3] == "000" or z[(i + 2) % 3] == "000"))
                    {
                        cout << "illegal" << endl;
                        return 0;
                    }
            ...
            else if (x == o)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    if (s[i % 3] == "000" and s[(i + 1) % 3] != "XXX" and s[(i + 2) % 3] != "XXX")
                    {
                        cout << "the second player won";
                        return 0;
                    }
                    else if (z[i % 3] == "000" and (z[(i + 1) % 3] == "XXX" or z[(i + 2) % 3] == "XXX"))
                    {
                        cout << "illegal" << endl;
                        return 0;
                    }
                ...
                for (int i = 0; i < n; i++)
                {
                    if (z[i % 3] == "000" and z[(i + 1) % 3] != "XXX" and z[(i + 2) % 3] != "XXX")
                    {
                        cout << "the second player won";
                        return 0;
                    }
