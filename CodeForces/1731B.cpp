...
int main() {
    ...
    tc{
        mint n;
        cin>>n;
        cout<<((n*(n+mint(1))*(mint(2)*n+mint(1))/mint(3)-n*(n+mint(1))/mint(2))*mint(2022))<<endl;
        //cout<<mmul((mmul(mmul(mmul(n,(n+1)),(2*n+1)),minv(3))-mmul(n,n)+mmul(mmul(n,(n+1)),minv(2LL))-n%mod+mod*mod)%mod,2022LL)%mod<<endl;
