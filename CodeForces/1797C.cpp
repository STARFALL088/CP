...
int main()
{
    ...
    tc
    {
        ...
        //hoy a th  row or a th col

        if(a>n){
            // a th row baad so just a th col check
            lli b=ask(n,a);
        ...
        if(a>m){
            // a th col baad so just a th row check
        ...
        //  a*a sqr er down or right side e
